  ...
  Widget build(BuildContext context) {
    ...
    switch (orderFlag) {
      ...
      case OrderEnum.ACCEPTED:
        ...
        onClickPrimaryBtn = () {
          //Modular.to.pushNamed(OrderModule.ORDER_SHIPPING_FORM);
          Modular.to.pushNamed(OrderModule.ORDER_SHIPPING);
        };
        break;
      case OrderEnum.PREPARE_DELIVERY:
        ...
        onClickPrimaryBtn = () {
          Modular.to.pushNamed(OrderModule.ORDER_SET_AS_DELIVERY);
        };
        break;
